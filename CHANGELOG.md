...
### Fixed
- There's no zip file attached to the release.

## [2.2.1] - 2024-12-11

### Fixed
- [SEC003] XSS vulnerability.

## [2.2.0] - 2024-11-22

### Added
- New updater system with no PII handling.
...
### Changed
- The plugin now checks updates availability on Github.
