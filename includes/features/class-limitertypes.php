...
class LimiterTypes {
	...
	public static function init() {
		...
		self::$selector_names['country']        = esc_html__( 'country', 'keys-master' );
		self::$selector_names['ip']             = esc_html__( 'IP address', 'keys-master' );
		self::$selector_names['device-class']   = esc_html__( 'device class', 'keys-master' );
		self::$selector_names['device-type']    = esc_html__( 'device type', 'keys-master' );
		self::$selector_names['device-client']  = esc_html__( 'client type', 'keys-master' );
		self::$selector_names['device-browser'] = esc_html__( 'browser', 'keys-master' );
		self::$selector_names['device-os']      = esc_html__( 'operating system', 'keys-master' );
	}
