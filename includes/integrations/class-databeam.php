...
namespace KeysMaster\Plugin\Integration;

use KeysMaster\System\Option;
use KeysMaster\System\Role;
use KeysMaster\Plugin\Core;
...
class Databeam {
	...
	/**
	 * Register Keys Master kpis endpoints for DataBeam.
	 *
	...
	public static function register_kpi( $integrations ) {
		$integrations[ POKM_SLUG . '::kpi' ] = [
			...
			'data_call'    =>
				[
					'static' => [
						'class'  => '\KeysMaster\Plugin\Feature\Analytics',
